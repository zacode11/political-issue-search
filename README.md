...
#### create_dataset()
This method will create the *politiciandataset* folder as well as the inverted index folder *idx* for use by the search engine.
```python
# example call
create_dataset()
```
